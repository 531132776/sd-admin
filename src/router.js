  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {/**外部客户端用户*/
          path: 'Externalclientuser',
          name: 'Externalclientuser',
          props: true,
          component: () => import('./views/dataStatistics/Externalclientuser.vue'),
          meta: { requireAuth: true },
        },
        {/**用户行为*/
          path: 'Userbehavior',
          name: 'Userbehavior',
          props: true,
          component: () => import('./views/dataStatistics/Userbehavior.vue'),
          meta: { requireAuth: true },
        },
        {/**用户行为-出售*/
          path: 'Userbehavior_Sell',
          name: 'Userbehavior_Sell',
          props: true,
          component: () => import('./views/dataStatistics/Userbehavior_Sell.vue'),
          meta: { requireAuth: true },
        },
        {/**用户行为-出租*/
          path: 'Userbehavior_lease',
          name: 'Userbehavior_lease',
          props: true,
          component: () => import('./views/dataStatistics/Userbehavior_lease.vue'),
          meta: { requireAuth: true },
        },
        {/**房源总列表*/
          path: 'HomeSourceList',
          name: 'HomeSourceList',
          props: true,
          component: () => import('./views/dataStatistics/HomeSourceList.vue'),
          meta: { requireAuth: true },
        },
        {/**房源总列表-出售*/
          path: 'HomeSourceList_Sell',
          name: 'HomeSourceList_Sell',
          props: true,
          component: () => import('./views/dataStatistics/HomeSourceList_Sell.vue'),
          meta: { requireAuth: true },
        },
        {/**房源总列表-出租*/
          path: 'HomeSourceList_lease',
          name: 'HomeSourceList_lease',
          props: true,
          component: () => import('./views/dataStatistics/HomeSourceList_lease.vue'),
          meta: { requireAuth: true },
        },
        {/**用户交易数据*/
          path: 'UserTransactionData',
          name: 'UserTransactionData',
          props: true,
          component: () => import('./views/dataStatistics/UserTransactionData.vue'),
          meta: { requireAuth: true },
        },
        {/**用户交易数据-出售*/
          path: 'UserTransactionData',
          name: 'UserTransactionData',
          props: true,
          component: () => import('./views/dataStatistics/UserTransactionData_Sell.vue'),
          meta: { requireAuth: true },
        },
        {/**用户交易数据-出租*/
          path: 'UserTransactionData',
          name: 'UserTransactionData',
          props: true,
          component: () => import('./views/dataStatistics/UserTransactionData_lease.vue'),
          meta: { requireAuth: true },
        },
        {/**内部人员数据*/
          path: 'Internalpersonneldata',
          name: 'Internalpersonneldata',
          props: true,
          component: () => import('./views/dataStatistics/Internalpersonneldata.vue'),
          meta: { requireAuth: true },
        },
        {/**内部人员数据-外看+外获详情*/
          path: 'Internalpersonneldetails',
          name: 'Internalpersonneldetails',
          props: true,
          component: () => import('./views/dataStatistics/Internalpersonneldetails.vue'),
          meta: { requireAuth: true },
        },
      ]
    },
